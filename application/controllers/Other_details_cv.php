...
class Other_details_cv extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('index.php/other_details_cv/index',$data);
    }
    ...
    {   
        ...
        else
        {
            ...
            $this->load->view('index.php/other_details_cv/add',$data);
    ...
    {   
        ...
        {   
            ...
            $this->load->view('includes/header.php');
            $this->load->view('includes/sidebar.php');
            $this->load->view('index.php/other_details_cv/edit',$data);
            $this->load->view('includes/footer.php');
        }
    }
