...
class General_detail_model extends CI_Model
{
    ...
    */
	function get_post_general_details_id($param){
		...
		$general_details_id = $row['general_details_id'];
		$array['general_details_id']= $general_details_id;		
		$this->db->set('general_details_id', $general_details_id);	
		$this->db->insert('update_general_details');		
		}
